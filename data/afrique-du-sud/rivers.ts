...
export const rivers: River[] = [
  {
    ...
    lengthKm: {
      ...
      note: "Plus long fleuve d'Afrique du Sud, connu des peuples khoïkhoï sous le nom de Gariep ; sur une partie de son cours, il forme la frontière entre l'Afrique du Sud et la Namibie.",
    },
  ...
  },
  {
    ...
    lengthKm: {
      ...
      note: "Principal affluent de l'Orange ; malgré un débit modeste, c'est le cours d'eau économiquement le plus vital du pays, alimentant en eau le Gauteng, cœur industriel et le plus peuplé d'Afrique du Sud.",
    },
