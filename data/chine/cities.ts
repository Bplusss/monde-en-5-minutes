...
export const cities: City[] = [
  ...
  { name: "Chongqing", lat: 29.5630, lon: 106.5516, population: { value: 32_054_159, year: 2020, source: SRC, note: "Municipalité la plus étendue du pays (environ 82 000 km², plus grande que l'Autriche), dont l'essentiel du territoire reste rural ; la zone urbaine centrale rassemble environ 10 millions d'habitants." } },
  ...
  { name: "Shenzhen", lat: 22.5431, lon: 114.0579, population: { value: 17_560_061, year: 2020, source: SRC, note: "Simple village de pêcheurs avant sa désignation comme première zone économique spéciale en 1980 ; devenue l'un des principaux pôles technologiques mondiaux." } },
